  ...
  return (
    <AppShell>
      <ScreenScroll contentContainerStyle={styles.screen}>
        ...
        {!query && <View style={[styles.invite, { backgroundColor: colors.surfaceStrong, borderColor: colors.border, borderWidth: 1 }]}><View style={styles.inviteIcon}><Sparkles color={colors.primary} size={32} /></View><View style={{ flex: 1 }}><AppText variant="h3" style={{ color: colors.textOnStrong }}>¿Tienes un código privado?</AppText><AppText style={{ color: colors.textOnStrong }}>Úsalo para entrar al grupo de tu clase, club o amistades.</AppText></View><Button label="Ingresar código" variant="secondary" compact /></View>}
      </ScreenScroll>
    </AppShell>
  );
}
