  ...
  return (
    <ScreenScroll contentContainerStyle={styles.screen}>
      ...
      {step === 0 ? <View style={styles.content}>
        <View style={styles.title}><View style={styles.icon}><GraduationCap color={colors.environmental} size={34} /></View><AppText variant="h1">Haz tu experiencia más tuya</AppText><AppText style={{ color: colors.textMuted }}>Tu afiliación ayuda a encontrar comunidades relevantes. Podrás cambiarla después.</AppText></View>
        ...
        <View style={styles.title}><View style={styles.icon}><UsersRound color={colors.environmental} size={34} /></View><AppText variant="h1">Elige dónde sumar</AppText><AppText style={{ color: colors.textMuted }}>Puedes pertenecer a varias comunidades; cada reciclaje aportará a una.</AppText></View>
...
const styles = StyleSheet.create({
  ...
  icon: { width: 54, height: 54, alignItems: 'center', justifyContent: 'center' },
